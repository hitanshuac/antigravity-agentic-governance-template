...
## Objective
A generalized, universal pipeline to scan the project for any programmatic diagram definitions (D2), compile them into structured images, and autonomously apply the Strict AI Styling Pass to guarantee aesthetic quality without spelling hallucinations.
...
2. Verify that all base `<diagram_name>_technical.png` files exist and are non-zero bytes.
