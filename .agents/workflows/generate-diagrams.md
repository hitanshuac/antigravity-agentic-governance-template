...
### Phase 3: The Showcase Styling Overlay
1. Per the `.agents/skills/diagram-generator/SKILL.md` rules, iterate through the list of generated `_technical.png` files.
2. Pass each `docs/assets/<diagram_name>_technical.png` into the `generate_image` tool.
3. Use the exact strict-spelling aesthetic prompt defined in `SKILL.md` to have the AI redraw the diagram.
4. Save the AI-styled output as `docs/assets/<diagram_name>_showcase.png`.
