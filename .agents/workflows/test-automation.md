...
> **Post-Mortem Origin:** This phase was added after unit tests using clean `tmpdir` directories passed 100% but missed a schema mismatch with the real `data/error_logs.json` file. See `20-00-phase-execute.md` Rule 2.5.
...
5. Reference: `00-01-core-safety.md` Rule 1, `20-00-phase-execute.md` Rule 2.5.
