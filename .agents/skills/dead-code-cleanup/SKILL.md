...
# Dead Code Cleanup & Semantic Pruning Skill
...
This skill utilizes a Map-Reduce pattern, coupling deterministic Abstract Syntax Tree (AST) tools for discovery of orphaned variables with LLM context-awareness to semantically prune out-of-scope code.
