---
name: Governance Self-Eval
description: "Runs the governance evaluation harness against the template's own history to establish a baseline. TRIGGERS: 'self eval', 'governance eval', 'evaluate governance', 'run evaluation harness', 'governance scorecard'."
---

# Governance Self-Eval
