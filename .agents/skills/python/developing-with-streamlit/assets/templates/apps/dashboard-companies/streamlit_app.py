...
def render_company_dialog(company_name: str, company_row: pd.Series, df: pd.DataFrame) -> None:
...
with st.container(border=True):
    ...
    timeframe_text = timeframe.lower() if timeframe and timeframe != "All time" else "all time"
