...
description: "Dual-engine pipeline combining Repowise AST dependency intelligence with D2 conceptual diagrams for comprehensive codebase visualization. TRIGGERS: 'generate diagrams', 'architecture diagram', 'dependency graph', 'visualize codebase', 'repowise', 'd2 diagram'."
---
...
## Phase 3: D2 Conceptual Diagrams
