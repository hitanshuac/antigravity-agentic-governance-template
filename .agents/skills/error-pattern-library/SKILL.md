...
- **Fix:** Truncate input using @.agents/skills/context-compactor/SKILL.md sliding window
...
- **Fix:** Use provider-native structured output per @.agents/skills/structured-output/SKILL.md
