...
- **`generate-diagrams`**: Dual-engine pipeline: repowise AST dependency graphs (Tree-sitter parsed, PageRank-ranked) + D2 conceptual architecture diagrams with AI showcase styling.
...
- **Orchestration**
  ...
  - **`update-docs`**: Triggers a pass over `README.md` and `docs/antigravity/HANDOVER.md` to ensure they match reality.
